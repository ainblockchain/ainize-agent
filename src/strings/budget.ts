...
export const BUDGET_STRINGS = {
  ...
  unresolved_note: { en: 'unfinished reservations from an earlier run: {count}, worth {amount} {unit} — counted as spent, because the act they were written for may have happened.', ko: '이전 실행에서 끝나지 않은 예약 {count}건 ({unit} {amount}) 이 사용한 것으로 계산됩니다 — 해당 작업이 실제로 일어났을 수 있습니다.' },
  /**
